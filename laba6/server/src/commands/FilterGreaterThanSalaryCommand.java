...
public class FilterGreaterThanSalaryCommand extends CommandImpl{
    ...
    public FilterGreaterThanSalaryCommand(CollectionManager<Worker> cm){
    ...
    public String execute(){
        ...
        List<Worker> list = collectionManager.printGreaterThanSalary(Long.parseLong(getStringArg()));
